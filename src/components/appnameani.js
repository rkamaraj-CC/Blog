  ...
  return (
    <>
      ...
      <div className="grid place-items-center ">
        <h1
          className="font-mono text-white text-2xl md:text-5xl p-0 md:p-0 rounded-md transition-colors duration-1000 ease-in-out hover:bg-lime-500 hover:text-white hover:shadow-lime-500"
